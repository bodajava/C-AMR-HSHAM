...
import { Rocket01Icon, ArrowRight02Icon } from "@hugeicons/core-free-icons";
		...
		<section className="mx-auto w-full max-w-5xl">
			...
			<div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-30">
				...
				<a
					...
					href="#"
				>
					<HugeiconsIcon icon={Rocket01Icon} strokeWidth={2} className="size-3 text-muted-foreground" />
					<span className="text-xs">Precision Training</span>
					<span className="block h-5 border-l" />

					<HugeiconsIcon icon={ArrowRight02Icon} strokeWidth={2} className="size-3 duration-150 ease-out group-hover:translate-x-1" />
				</a>
				...
				>
					Elevate your performance <br /> with scientific precision.
				</h1>
				...
				<p className="fade-in slide-in-from-bottom-10 mx-auto max-w-xl animate-in fill-mode-backwards text-center text-base text-foreground/80 tracking-wider delay-200 duration-500 ease-out sm:text-lg md:text-xl">
					Bespoke fitness and nutrition coaching designed for those who demand excellence. Transform your lifestyle through clarity, data, and dedicated mentorship.
				</p>

				<div className="fade-in slide-in-from-bottom-10 flex animate-in flex-row flex-wrap items-center justify-center gap-3 fill-mode-backwards pt-2 delay-300 duration-500 ease-out">
					<Button asChild className="rounded-full" size="lg" variant="secondary">
						<a href="#philosophy">Explore Philosophy</a>
					</Button>
