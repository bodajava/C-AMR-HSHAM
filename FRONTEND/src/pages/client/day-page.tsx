...
import { ExerciseVideoModal } from "@/components/workouts/exercise-video-modal";
...
export default function DayPage() {
  ...
  const { targetClientId } = useAssignment();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (isDay) {
          const planRes = await weeklyPlanApi.getByDay(workoutId.toLowerCase(), targetClientId || undefined);
